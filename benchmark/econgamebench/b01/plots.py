...
Run with SYSTEM python3 (the .venv has no matplotlib):
    python3 -m benchmark.econgamebench.b01.plots          # or: python3 benchmark/econgamebench/b01/plots.py

Reads results.csv, writes benchmark/econgamebench/b01/plots/<game>.png: one histogram panel
