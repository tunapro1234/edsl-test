...
Run with SYSTEM python3 (the .venv has no matplotlib):
    python3 -m benchmark.beebench.b01.plots          # or: python3 benchmark/beebench/b01/plots.py

Reads results.csv, writes benchmark/beebench/b01/plots/<game>.png: one histogram panel
